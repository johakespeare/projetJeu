...
public class TestPersonnage {
    ...
    public static void main(String[] args) {
        ...
        Munition fleche = new Munition(10,10,POSXMAX,POSYMAX,2,2);
        ...
        //*********************************************COLLISION********************************************************
            ...
            assert(arthur2.getPv()==94):"arthur n'a pas ce nb de pv "+arthur2.getPv();

            legolas2.augmenterDegats();
            assert(legolas2.getArmeDeTir().getMunition().getDegats()==3):"les dégats de la munition ne sont pas égaux à 3"
                    +legolas2.getArmeDeTir().getMunition().getDegats();


            arthur2.augmenterDegats();
            assert(arthur2.getDegats()==3):"les dégats de l'épée ne sont pas égaux à 3";
